...
export const Level3Login: React.FC<Level3LoginProps> = ({ 
  ...
  return (
    <div id="level3-login-screen" className="min-h-screen bg-[#F7F3EA] text-[#241B2F] flex flex-col justify-between font-sans">
      {/* Top Header */}
      <header className="border-b border-[#3A2B49] bg-[#21152F] px-4 sm:px-8 py-3.5 flex items-center justify-between shadow-md">
        <div className="flex items-center space-x-3">
          ...
          <span className="font-bold text-white text-sm tracking-tight">Level 3 Login</span>
        </div>
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-md bg-[#FFFDF8] border border-[#E5DED2] rounded-3xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            {errorMsg && (
              <div id="l3-login-error-alert" className="p-3 bg-rose-50 border border-rose-200 text-rose-700 text-xs rounded-xl flex items-start space-x-2 font-medium">
            ...
            <div>
              <label htmlFor="l3-email-input" className="block text-xs font-semibold text-[#241B2F] mb-1.5">
                Email or Username
              </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="l3-password-input" className="block text-xs font-semibold text-[#241B2F]">
                  Password
                </label>
                <button
                  type="button"
