...
export const Level2Login: React.FC<Level2LoginProps> = ({ 
  ...
  return (
    <div id="level2-login-screen" className="min-h-screen bg-[#F7F3EA] text-[#241B2F] flex flex-col justify-between font-sans">
      {/* Top Header */}
      <header className="border-b border-[#3A2B49] bg-[#21152F] px-4 sm:px-8 py-3.5 flex items-center justify-between shadow-md">
        <div className="flex items-center space-x-3">
          ...
          <span className="font-bold text-white text-sm tracking-tight">Level 2 Login</span>
        </div>
        ...
        <div className="w-full max-w-md bg-[#FFFDF8] border border-[#E5DED2] rounded-3xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="p-6 bg-[#21152F] text-white text-center border-b border-[#3A2B49]">
            ...
            <p className="text-xs text-[#D9D0E3] mt-1 font-medium">
              Enter your credentials to sign in to Level 2.
            </p>
          </div>

          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            {errorMsg && (
              <div id="l2-login-error-alert" className="p-3 bg-rose-50 border border-rose-200 text-rose-700 text-xs rounded-xl flex items-start space-x-2 font-medium">
            ...
            <div>
              <label htmlFor="l2-email-input" className="block text-xs font-semibold text-[#241B2F] mb-1.5">
                Email or Username
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="sunita.rao@gracechurch.org"
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="l2-password-input" className="block text-xs font-semibold text-[#241B2F]">
                  Password
                </label>
                <button
                  type="button"
        ...
        <div className="fixed inset-0 bg-[#21152F]/70 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-[#FFFDF8] border border-[#E5DED2] rounded-3xl p-6 max-w-sm w-full space-y-4 shadow-2xl text-center">
            ...
            <p className="text-xs text-[#62586B]">
              Please contact your Diocesan Finance Administrator to reset your credentials.
            </p>
            <button
      ...
      <footer className="border-t border-[#E5DED2] bg-[#FFFDF8] py-3.5 text-center text-xs text-[#62586B] font-medium">
        Level 2 Financial Control Portal &bull; Church Financial Management Platform
      </footer>
    </div>
  );
};
